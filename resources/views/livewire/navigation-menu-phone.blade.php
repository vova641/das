<div 
    class="navigation-menu-phone fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        <a href="{{ route('dashboard') }}" data-tooltip-target="tooltip-home" type="button"
        ...
        <button data-modal-target="crypto-modal" data-modal-toggle="crypto-modal" data-tooltip-target="tooltip-wallet"
            type="button"
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                <span class="sr-only">Котегории постов</span>
            </button>
            <!-- Modal header -->
            ...
            <!-- Modal body -->
            <div class="p-6">
                <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Здесь все категории постов!</p>
